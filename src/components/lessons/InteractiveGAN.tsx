  ...
  return (
    <div className="my-8 flex flex-col gap-6 p-6 bg-white border border-rose-200 rounded-xl shadow-xl">
      <div className="flex justify-between items-center -mt-2">
        <h2 className="text-xl font-bold text-rose-950 tracking-tight">Generative Adversarial Networks (GANs)</h2>
        ...
        <div className="lg:col-span-12 flex justify-between items-center bg-rose-100 p-4 rounded-lg border border-rose-200">
          ...
          <div className="flex gap-8">
            <div className="flex flex-col items-end">
              <span className="text-[10px] font-bold text-rose-700 uppercase tracking-widest">Epoch</span>
              <span className="font-mono font-bold text-rose-950 text-lg">{epoch} / {totalEpochs}</span>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-12 flex flex-col items-center justify-center bg-rose-50 rounded-xl border border-rose-200 p-8 min-h-[400px]">
          ...
          <div className="w-full flex flex-col md:flex-row items-center justify-between gap-8 max-w-4xl">
            ...
            <div className="flex flex-col items-center gap-4 flex-1">
              <h3 className="text-xs font-bold text-indigo-700 uppercase tracking-widest border border-indigo-900/50 bg-indigo-50 px-3 py-1 rounded-full">The Generator</h3>
              
              <div className="text-[10px] font-mono text-rose-700 bg-rose-100 px-2 py-1 rounded">Random Noise (Latent Vector)</div>
              
              <svg width="20" height="30" className="text-indigo-600">
              ...
              <div className="w-full h-32 bg-indigo-50 border-2 border-indigo-500/50 rounded-xl flex items-center justify-center relative overflow-hidden shadow-[0_0_20px_rgba(99,102,241,0.1)]">
                <div className="text-indigo-600 font-bold tracking-widest">G(z)</div>
              ...
              <div className="flex flex-col items-center">
                <div className="text-[10px] font-bold text-rose-700 uppercase tracking-widest mb-2">Generated Fake</div>
                <div className="w-24 h-24 bg-black border-2 border-indigo-900 rounded flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="text-6xl font-bold text-rose-200 z-10" style={{ opacity: realism }}>
                    8
                  </div>
                </div>
              </div>
            ...
            {/* ================= DISCRIMINATOR ================= */}
            <div className="flex flex-col items-center gap-4 flex-1">
              <h3 className="text-xs font-bold text-rose-600 uppercase tracking-widest border border-rose-900/50 bg-rose-50 px-3 py-1 rounded-full">The Discriminator</h3>
              
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <div className="text-[10px] font-bold text-rose-700 uppercase tracking-widest mb-2">Real Image</div>
                  <div className="w-16 h-16 bg-rose-100 border-2 border-emerald-900 rounded flex items-center justify-center text-4xl font-bold text-emerald-600">
                    8
                  </div>
                </div>
                <div className="flex flex-col items-center justify-center">
                  <span className="text-[10px] font-bold text-rose-600 mb-2">OR</span>
                </div>
                <div className="flex flex-col items-center">
                  <div className="text-[10px] font-bold text-rose-700 uppercase tracking-widest mb-2">Fake Image</div>
                  <div className="w-16 h-16 bg-rose-100 border-2 border-indigo-900 rounded flex items-center justify-center text-xs font-bold text-indigo-700">
              ...
              <div className="flex justify-center w-full gap-8">
                <svg width="20" height="30" className="text-emerald-600 rotate-[30deg]">
                  <path d="M 10 0 L 10 25 M 5 20 L 10 28 L 15 20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
                <svg width="20" height="30" className="text-indigo-600 -rotate-[30deg]">
                  <path d="M 10 0 L 10 25 M 5 20 L 10 28 L 15 20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>

              <div className="w-full h-32 bg-rose-50 border-2 border-rose-500/50 rounded-xl flex flex-col items-center justify-center relative overflow-hidden shadow-[0_0_20px_rgba(244,63,94,0.1)] gap-2">
                <div className="text-rose-300 font-bold tracking-widest">D(x)</div>
                <div className="text-[10px] font-mono text-rose-600 bg-rose-950/50 px-2 py-0.5 rounded">Accuracy: {dAccuracy.toFixed(1)}%</div>
              </div>

              <svg width="20" height="30" className="text-rose-600">
                <path d="M 10 0 L 10 25 M 5 20 L 10 28 L 15 20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>

              <div className="text-[10px] font-bold text-rose-950 bg-rose-600 px-4 py-2 rounded shadow-lg uppercase tracking-widest">
                Is it Real or Fake?
              </div>
            </div>
          ...
          <div className="mt-12 w-full max-w-4xl p-4 bg-rose-100/50 border border-rose-200 rounded-lg flex items-start gap-4">
