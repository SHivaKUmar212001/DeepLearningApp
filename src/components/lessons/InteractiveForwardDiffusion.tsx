  ...
  return (
    <div className="my-8 flex flex-col gap-6 p-6 bg-white border border-rose-200 rounded-xl shadow-xl">
      <div className="flex justify-between items-center -mt-2">
        <h2 className="text-xl font-bold text-rose-950 tracking-tight">The Forward Process</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          <div className="p-4 bg-rose-100 rounded-lg border border-rose-200 flex flex-col gap-4">
            <h3 className="text-sm font-medium text-cyan-600">Time Step ($t$)</h3>
            ...
            <div className="mt-4 bg-rose-50 p-4 rounded border border-rose-200 flex flex-col gap-3">
              <div className="text-xs font-bold text-rose-600 uppercase tracking-widest">Signal-to-Noise Ratio</div>
              
              <div className="flex items-center gap-4">
                <div className="w-16 text-right font-mono text-xs text-indigo-700 font-bold">Signal</div>
                <div className="flex-1 h-2 bg-rose-50 rounded-full overflow-hidden">
                  <div className="h-full bg-indigo-500" style={{ width: `${signalOpacity * 100}%` }} />
                </div>
                <div className="w-10 text-right font-mono text-xs text-rose-700">{(signalOpacity * 100).toFixed(0)}%</div>
              </div>

              <div className="flex items-center gap-4">
                <div className="w-16 text-right font-mono text-xs text-rose-600 font-bold">Noise</div>
                <div className="flex-1 h-2 bg-rose-50 rounded-full overflow-hidden">
                  <div className="h-full bg-rose-500" style={{ width: `${noiseIntensity * 100}%` }} />
                </div>
                <div className="w-10 text-right font-mono text-xs text-rose-700">{(noiseIntensity * 100).toFixed(0)}%</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-7 flex flex-col items-center justify-center bg-rose-50 rounded-xl border border-rose-200 p-8 min-h-[350px]">
          ...
          <div className="flex flex-col items-center gap-8">
            <h3 className="text-[10px] font-bold text-rose-700 uppercase tracking-widest text-center">
              Image at $x_t$
            </h3>
            
            <div className="w-48 h-48 bg-black border-2 border-rose-300 rounded-xl relative overflow-hidden shadow-[0_0_30px_rgba(0,0,0,0.5)] flex items-center justify-center">
              ...
              <div 
                className="text-rose-200 text-9xl font-bold z-10 transition-opacity duration-100"
            ...
            <div className="text-[10px] font-mono text-rose-700 text-center max-w-sm">
