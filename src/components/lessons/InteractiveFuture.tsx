      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7 flex flex-col items-center justify-center bg-[#111128] rounded-xl border border-white/[0.08] p-4 min-h-[450px] relative overflow-hidden">
          ...
          <svg className="absolute inset-0 w-full h-full pointer-events-none" style={{ overflow: 'visible' }}>
            ...
            <path d="M 35% 65% Q 50% 80% 50% 90%" fill="none" stroke="#374151" strokeWidth="3" strokeDasharray="5 5" />
            <path d="M 65% 65% Q 50% 80% 50% 90%" fill="none" stroke="#374151" strokeWidth="3" strokeDasharray="5 5" />
          </svg>
