  ...
  return (
    <div className="my-8 flex flex-col gap-6 p-6 bg-white border border-rose-200 rounded-xl shadow-xl">
      <div className="flex justify-between items-center -mt-2">
        <h2 className="text-xl font-bold text-rose-950 tracking-tight">Interactive Vectors</h2>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="flex flex-col gap-6">
          ...
          <div className="p-4 bg-rose-100 rounded-lg border border-rose-200">
            <h3 className="text-sm font-medium text-cyan-600 mb-4">Vector 1 (v₁)</h3>
          ...
          <div className="p-4 bg-rose-100 rounded-lg border border-rose-200">
            <h3 className="text-sm font-medium text-amber-600 mb-4">Vector 2 (v₂)</h3>
            <div className="flex flex-col gap-4">
          ...
          <div className="flex gap-6 p-4 bg-rose-100 rounded-lg border border-rose-200">
        ...
        <div className="flex flex-col gap-4">
          ...
          {/* Readout Panel */}
          <div className="bg-rose-50 rounded-xl border border-rose-200 p-4 font-mono text-sm grid grid-cols-2 gap-4">
            <div className="flex flex-col">
              <span className="text-rose-700 mb-1">Dot Product (v₁ • v₂)</span>
              <span className={`text-xl font-bold ${dotProduct > 0 ? "text-emerald-600" : dotProduct < 0 ? "text-red-400" : "text-rose-600"}`}>
                {dotProduct.toFixed(2)}
              </span>
            </div>
            <div className="flex flex-col">
              <span className="text-rose-700 mb-1">Angle (θ)</span>
              <span className="text-xl text-rose-950 font-bold">{angleDeg.toFixed(1)}°</span>
            </div>
          </div>
        </div>
      </div>
