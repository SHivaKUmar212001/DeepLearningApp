        ...
        <div className="lg:col-span-7 flex flex-col items-center justify-center bg-[#111128] rounded-xl border border-white/[0.08] p-8 min-h-[350px]">
          ...
          <div className="w-full flex flex-col md:flex-row items-center justify-around gap-8">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <div className={`w-32 h-32 bg-white/[0.04] border-2 ${cfg > 12 ? 'border-teal-600/40/50 shadow-[0_0_15px_rgba(244,63,94,0.3)]' : 'border-white/[0.1]'} rounded-xl flex items-center justify-center relative overflow-hidden transition-all duration-300`}>
                <div 
