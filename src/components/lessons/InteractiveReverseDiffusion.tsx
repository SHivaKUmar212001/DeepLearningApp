  ...
  return (
    <div className="my-8 flex flex-col gap-6 p-6 bg-white border border-rose-200 rounded-xl shadow-xl">
      <div className="flex justify-between items-center -mt-2">
        <h2 className="text-xl font-bold text-rose-950 tracking-tight">The Reverse Process</h2>
        ...
        <div className="lg:col-span-12 flex justify-between items-center bg-rose-100 p-4 rounded-lg border border-rose-200">
          ...
          <div className="flex gap-8">
            <div className="flex flex-col items-end">
              <span className="text-[10px] font-bold text-rose-700 uppercase tracking-widest">Time Step (t)</span>
              <span className="font-mono font-bold text-rose-950 text-lg">{timeStep}</span>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-12 flex flex-col items-center justify-center bg-rose-50 rounded-xl border border-rose-200 p-8 min-h-[400px]">
          ...
          <div className="w-full flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 max-w-4xl">
            ...
            <div className="flex flex-col items-center gap-4">
              <h3 className="text-xs font-bold text-rose-700 uppercase tracking-widest">Current Image $x_t$</h3>
              <div className="w-32 h-32 bg-black border-2 border-rose-300 rounded-xl relative overflow-hidden shadow-[0_0_20px_rgba(0,0,0,0.5)] flex items-center justify-center">
                <div 
                  className="absolute inset-0 mix-blend-screen" 
                  style={{ backgroundImage: getNoiseFilter(), opacity: noiseIntensity > 0.05 ? noiseIntensity : 0 }} 
                />
                <div 
                  className="text-rose-200 text-7xl font-bold z-10"
            ...
            <div className="flex flex-col items-center gap-2">
              <div className="text-[10px] font-bold text-indigo-500 uppercase tracking-widest">Neural Network</div>
              <svg width="40" height="20" className="text-indigo-600">
              ...
              <div className="w-32 h-24 bg-indigo-50 border-2 border-indigo-500/50 rounded-xl flex items-center justify-center shadow-[0_0_15px_rgba(99,102,241,0.1)] relative overflow-hidden">
                <div className="text-indigo-600 font-bold tracking-widest">U-Net</div>
                {isPlaying && (
              ...
              <div className="text-[10px] font-bold text-rose-700 uppercase tracking-widest">Predict Noise</div>
            </div>

            {/* Predicted Noise */}
            <div className="flex flex-col items-center gap-4">
              <h3 className="text-xs font-bold text-rose-600 uppercase tracking-widest">Predicted Noise {"$\\epsilon_\\theta$"}</h3>
              <div className="w-32 h-32 bg-black border-2 border-rose-900 rounded-xl relative overflow-hidden flex items-center justify-center">
                <div 
                ...
                />
                {timeStep === 0 && (
                  <div className="text-rose-600 font-mono text-xs">No noise</div>
                )}
              </div>
            </div>
